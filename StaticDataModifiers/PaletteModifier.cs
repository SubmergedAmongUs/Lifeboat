...
public sealed class PaletteModifier : StaticDataModifier
{
    private Il2CppStructArray<StringNames> OriginalColorNames;
    private Il2CppStructArray<Color32> OriginalPlayerColors;
    private Il2CppStructArray<Color32> OriginalShadowColors;
        
    public override void Patch()
    {
        OriginalColorNames = Palette.ColorNames;
        OriginalPlayerColors = Palette.PlayerColors;
        OriginalShadowColors = Palette.ShadowColors;
        ...
        Palette.PlayerColors = new[]
        {
            ...
            new Color32(66, 245, 170, byte.MaxValue),
            new Color32(1, 166, 255, byte.MaxValue),
            new Color32(255, 222, 33, byte.MaxValue)
        };
        ...
        Palette.ShadowColors = new[]
        {
            ...
            new Color32(69, 196, 143, byte.MaxValue),
            new Color32(17, 104, 151, byte.MaxValue),
            new Color32(186, 164, 37, byte.MaxValue)
        };
    }

    public override void Unpatch()
    {
        Palette.ColorNames = OriginalColorNames;
        Palette.PlayerColors = OriginalPlayerColors;
        Palette.ShadowColors = OriginalShadowColors;
    }
}